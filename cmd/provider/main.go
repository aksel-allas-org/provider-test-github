...
import (
	...
	"github.com/aksel-allas-org/provider-test-github/apis"
	"github.com/aksel-allas-org/provider-test-github/apis/v1alpha1"
	"github.com/aksel-allas-org/provider-test-github/config"
	"github.com/aksel-allas-org/provider-test-github/internal/clients"
	"github.com/aksel-allas-org/provider-test-github/internal/controller"
	"github.com/aksel-allas-org/provider-test-github/internal/features"
)

func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Test-GitHub").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-test-github"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-test-github",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add Test-GitHub APIs to scheme")
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Test-GitHub controllers")
